...
| Find / FindAsync | 批量查找键对应的值 | [API文档 - Find](docs/API文档和使用示例.md#34-find---查找键对应的值) |
| FindIf / FindIfAsync | 批量条件查找键对应的值 | [API文档 - FindIf](docs/API文档和使用示例.md#35-findif---条件查找键对应的值) |
...
| Count | 批量统计键存在的数量 | [API文档 - Count](docs/API文档和使用示例.md#311-count---统计键存在的数量) |
| Capacity | 获取哈希表容量 | [API文档 - Capacity](docs/API文档和使用示例.md#312-capacity---获取容量) |
| Data | 获取数据指针 | [API文档 - Data](docs/API文档和使用示例.md#313-data---获取数据指针) |
