...
template <typename K, int BucketSize>
ClearTestContext<K, BucketSize>& GetContext() {
    static ClearTestContext<K, BucketSize> ctx;
    return ctx;
}
...
REGISTER_PERFORMANCE_TEST(clearCase1, (TestClear<uint32_t,1>), (SetupClearTest<uint32_t,1>), int);
REGISTER_PERFORMANCE_TEST(clearCase2, (TestClear<uint64_t,1>), (SetupClearTest<uint64_t,1>), int);
REGISTER_PERFORMANCE_TEST(clearAsyncCase1, (TestClearAsync<uint32_t,1>), (SetupClearTest<uint32_t,1>), int);
REGISTER_PERFORMANCE_TEST(clearAsyncCase2, (TestClearAsync<uint64_t,1>), (SetupClearTest<uint64_t,1>), int);
