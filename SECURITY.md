...
| :---: | :----------: | :---------------- | :------------------------------------------------------------------------------------------ | :------------------------------------------ |
| 依赖  |    不涉及    | 3rdparty/doxygen | https://github.com/doxygen/doxygen.git | 从github下载doxygen源码，作用api文档生成编译依赖 |
| 依赖  |    不涉及    | 3rdparty/Catch2  | https://github.com/catchorg/Catch2.git                                                      | 从github下载Catch2源码，作用功能测试框架编译依赖        |
---
